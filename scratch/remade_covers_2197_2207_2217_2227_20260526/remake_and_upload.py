...
STORIES = [
    {
        "id": 2227,
        "chapter": 8,
        "source": ROOT / "base/2227_base.png",
        "title_lines": ["THIÊN TÀI", "LẬP TRÌNH", "LẬT ĐỔ TÀI CHÍNH"],
        "colors": [(255, 255, 255), (92, 232, 255), (255, 184, 43)],
    },
    {
        "id": 2217,
        "chapter": 8,
        "source": ROOT / "base/2217_base.png",
        "title_lines": ["BÓNG TỐI", "ĐIỆN LỰC", "VẠN THỊNH"],
        "colors": [(255, 255, 255), (92, 232, 255), (255, 184, 43)],
    },
    {
        "id": 2207,
        "chapter": 8,
        "source": ROOT / "base/2207_base.png",
        "title_lines": ["THUYỀN TRƯỞNG", "CẢNG ĐÀ THÀNH", "CHIẾN BÊN BẾN CẢ"],
        "colors": [(255, 255, 255), (255, 184, 43), (92, 232, 255)],
    },
    {
        "id": 2197,
        "chapter": 8,
        "source": ROOT / "base/2197_base.png",
        "title_lines": ["THỢ HỒ", "NGHÌN TỶ", "ĐẬP TAN KIÊU NGẠO"],
        "colors": [(255, 255, 255), (255, 184, 43), (92, 232, 255)],
    },
]
...
def make_preview(covers):
    sheet = Image.new("RGB", (2 * 420, 2 * 470), "white")
    draw = ImageDraw.Draw(sheet)
    for idx, (story, path) in enumerate(covers):
        thumb = Image.open(path).convert("RGB")
        thumb.thumbnail((390, 390))
        x = (idx % 2) * 420 + 15
        y = (idx // 2) * 470 + 15
        sheet.paste(thumb, (x, y))
        draw.text((x, y + 400), f"{story['id']} - {path.name}", fill=(0, 0, 0))
