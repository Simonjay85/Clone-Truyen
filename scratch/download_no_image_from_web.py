...
url = "https://doctieuthuyet.com/wp-content/themes/tehi-theme/img_data/images/no-image-cover.png"
dst_dir = "/Users/aaronnguyen/.gemini/antigravity-ide/brain/12ea8d69-8883-4c0b-9ecb-fc7822e46167"
dst_path = os.path.join(dst_dir, "no-image-web-check.png")
...
try:
    ...
    with Image.open(dst_path) as img:
        ...
        print("Most common colors of no-image from web:")
        for color, count in counter.most_common(10):
            print(f"Color: {color}, Count: {count}")
            
except Exception as e:
    print("Error downloading or analyzing from web:", e)
