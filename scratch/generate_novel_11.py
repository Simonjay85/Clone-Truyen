...
def save_stage_1(title, author, intro, c1_title, c1_text, c2_title, c2_text, c3_title, c3_text):
    data = {
        "idx": 11,
        "title": title,
        "author": author,
        ...
        "chapters": [
            {"title": c1_title, "content": txt_to_html(c1_text)},
            {"title": c2_title, "content": txt_to_html(c2_text)},
            {"title": c3_title, "content": txt_to_html(c3_text)}
        ]
    }
    with open(TEMP_PATH, "w", encoding="utf-8") as f:
        json.dump(data, f, ensure_ascii=False, indent=2)
    print("Stage 1 completed: Chapters 1-3 written to temp file.")
...
Ngồi kế bên gã là đạo diễn Ngô Quang Đạt – kẻ nổi tiếng trong giới với những bộ phim mì ăn liền hài nhảm rẻ tiền nhưng đầy mưu mô.
...
Trên màn hình là một bài báo lá cải vừa lên trang với dòng tít lớn: "Đạo diễn trẻ Lý Quốc Anh bị tố đạo nhái kịch bản từ phim độc lập Hàn Quốc."
...
Dù trang thiết bị thiếu thốn, nhưng không khí trong đoàn phim vô cùng nghiêm tinesiêu, từng góc máy, từng tấm phản quang đều được bố trí tỉ mỉ dưới sự chỉ đạo của anh.
...
"Ai cho các người quay phim ở đây?" Đinh Hùng hất hàm, gã cầm một tập tài liệu bướcc tới giật phắt chiếc loa cầm tay từ tay Quốc Anh.
