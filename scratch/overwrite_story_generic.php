 ...
 * Chức năng: Xóa sạch các chương cũ và chèn 8 chương mới nguyên bản để tránh trùng lặp hoặc mâu thuẫn cho bất kỳ Story ID nào.
 */
...
if (empty($story_id) || empty($title) || empty($intro) || empty($chapters)) {
    ...
    echo json_encode(['error' => 'Thiếu thông tin story_id, tiêu đề, mô tả hoặc danh sách chương!']);
    exit;
}
