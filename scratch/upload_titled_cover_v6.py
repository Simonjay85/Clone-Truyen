...
$file_array = array(
    'name' => 'cover-' . $post_id . '-standard-v6.png',
    'tmp_name' => $tmp
);
...
def main():
    story_id = 2197
    local_titled_path = "/Users/aaronnguyen/.gemini/antigravity/brain/5d44a410-5358-4686-9682-b008f3aa2f8f/cover_2197_standard_v6.png"
    ...
    # Upload image
    remote_filename = "cover_temp_2197_standard_v6.png"
