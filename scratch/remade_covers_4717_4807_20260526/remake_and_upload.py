...
STORIES = [
    {
        "id": 4807,
        "source": ROOT / "base/4807_base.png",
        "title_lines": ["BỊ HỦY HÔN", "VUA TRẦM HƯƠNG", "LẬT KÈO TRĂM TỶ"],
        "colors": [(255, 255, 255), (255, 184, 43), (92, 232, 255)],
    },
    {
        "id": 4795,
        "source": ROOT / "base/4795_base.png",
        "title_lines": ["BỊ KHINH RẺ", "LAU GIÀY CHO VỢ", "SÁNG CHẾ KỲ NAM"],
        "colors": [(255, 255, 255), (92, 232, 255), (255, 184, 43)],
    },
    {
        "id": 4771,
        "source": ROOT / "base/4771_base.png",
        "title_lines": ["NGHỆ NHÂN", "HOA MUỐI CÀ NÁ", "PHƠI BÀY MUỐI BẨN"],
        "colors": [(255, 255, 255), (92, 232, 255), (255, 184, 43)],
    },
    {
        "id": 4761,
        "source": ROOT / "base/4761_base.png",
        "title_lines": ["THẦN DƯỢC LIỆU", "SAPA", "BẪY IPO DƯỢC PHẨM"],
        "colors": [(255, 255, 255), (92, 232, 255), (255, 184, 43)],
    },
    {
        "id": 4750,
        "source": ROOT / "base/4750_base.png",
        "title_lines": ["VUA QUẾ", "TRÀ BỒNG", "TINH DẦU NGHÌN TỶ"],
        "colors": [(255, 255, 255), (255, 184, 43), (92, 232, 255)],
    },
    {
        "id": 4740,
        "source": ROOT / "base/4740_base.png",
        "title_lines": ["BỊ CƯỚP", "TRẠI MẬT ONG", "VẢ SẬP TẬP ĐOÀN"],
        "colors": [(255, 255, 255), (255, 184, 43), (92, 232, 255)],
    },
    {
        "id": 4729,
        "source": ROOT / "base/4729_base.png",
        "title_lines": ["THẦN Y", "BỊ SA THẢI", "SÂM NGỌC LINH"],
        "colors": [(255, 255, 255), (255, 184, 43), (92, 232, 255)],
    },
    {
        "id": 4717,
        "source": ROOT / "base/4717_base.png",
        "title_lines": ["VUA SÂM", "NGỌC LINH KON TUM", "THÂU TÓM DƯỢC LIỆU"],
        "colors": [(255, 255, 255), (255, 184, 43), (92, 232, 255)],
    },
]
...
def make_preview(covers):
    sheet = Image.new("RGB", (4 * 330, 2 * 380), "white")
    ...
    for idx, (story, path) in enumerate(covers):
        ...
        draw.text((x, y + 320), f"{story['id']} - {path.name}", fill=(0, 0, 0))
