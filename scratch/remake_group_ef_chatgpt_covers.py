...
OUT_DIR = Path("scratch/group_ef_chatgpt_covers_20260522")
CANVAS = 1200
...
STORIES = [
    {"id": 1984, "chapter": 8, "source": OUT_DIR / "base/1984_base.png", "title_lines": ["GIẢ NGHÈO RA MẮT", "SÍNH LỄ 900 TRIỆU", "LẬT KÈO CHUNG CƯ"], "colors": [(255, 255, 255), (255, 64, 64), (255, 184, 43)]},
    {"id": 1968, "chapter": 8, "source": OUT_DIR / "base/1968_base.png", "title_lines": ["THÀNH PHỐ TẮT ĐÈN", "KỸ SƯ BỊ GỌI ĐIÊN", "BẬT NGUỒN SÁNG"], "colors": [(92, 232, 255), (255, 64, 64), (255, 184, 43)]},
    {"id": 1948, "chapter": 8, "source": OUT_DIR / "base/1948_base.png", "title_lines": ["GIÁM ĐỐC NGẦM", "BỊ CƯỚP DỰ ÁN", "CẢ CÔNG TY ĐỨNG HÌNH"], "colors": [(92, 232, 255), (255, 64, 64), (255, 184, 43)]},
    {"id": 1933, "chapter": 8, "source": OUT_DIR / "base/1933_base.png", "title_lines": ["CON BÉ GẦN MÁY IN", "GẤU BÔNG QUỶ VƯƠNG", "LẬT SỔ ĐEN"], "colors": [(255, 255, 255), (255, 184, 43), (255, 64, 64)]},
    {"id": 1927, "chapter": 8, "source": OUT_DIR / "base/1927_base.png", "title_lines": ["MẸ CHỒNG ĐUỔI TÔI", "SỔ ĐỎ GÒ VẤP", "ĐỨNG TÊN RIÊNG"], "colors": [(255, 255, 255), (255, 64, 64), (255, 184, 43)]},
    {"id": 1921, "chapter": 8, "source": OUT_DIR / "base/1921_base.png", "title_lines": ["CON DÂU DÂN TỈNH", "NHÀ 4,8 TỶ", "CẢ HỌ TRẮNG MẶT"], "colors": [(255, 255, 255), (92, 232, 255), (255, 184, 43)]},
]
...
def upload_and_set(covers):
    ...
    try:
        ...
        for story, cover_path in covers:
            remote_name = f"chatgpt_group_ef_cover_{story['id']}_20260522.png"
