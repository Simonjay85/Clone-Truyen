...
STORY_LIST = [
    {"id": 2668, "title_hint": "Cô Vợ Hào Môn Khinh Tôi Vô Dụng, Cả Hà Ngoại Biết Tôi Là Chủ Tịch Tập Đoàn Thép"},
    {"id": 2675, "title_hint": "Sư Phụ Đuổi Tôi Khỏi Võ Quán Vì Hèn Yếu, Giải Vô Địch Quốc Gia Gọi Tên Tôi"},
    {"id": 2682, "title_hint": "Bố Vợ Ép Ly Hôn Vì Tôi Nghèo Hèn, Công Ty Tỷ Đô Của Tôi Niêm Yết"},
    {"id": 2689, "title_hint": "Giám Đốc Bệnh Viện Sa Thải Bác Sĩ Thực Tập, Hội Đồng Y Tế Quốc Gia Bổ Nhiệm"},
    {"id": 2696, "title_hint": "Nhà Chồng Khinh Tôi Không Biết Nấu Ăn, Tôi Giật Giải Đầu Bếp Michelin"}
]
...
2. BỐI CẢNH ĐỊA DANH THẬT VIỆT NAM: Câu chuyện phải diễn ra tại các địa điểm có thật ở Việt Nam như đường phố Hà Nội (Cầu Giấy, Hoàn Kiếm, Long Biên, Mỹ Đình), TP.HCM (Phú Mỹ Hưng Quận 7, Landmark 81, Quận 1), Hải Phòng (cảng Đình Vũ, Đồ Sơn), v.v. Các tòa nhà, văn phòng cụ thể. Tên nhân vật thuần Việt (ví dụ: Diệp Phong, Lâm Hạo, Trần Hải, Hoàng Oanh, v.v.).
3. NỮ CHÍNH LÝ TÍNH ĐẶT ĐIỀU KIỆN TRƯỚC KHI HỢP TÁC: Nữ chính hoặc trợ lý đồng hành là người cực kỳ tài năng, có đầu óc sắc sảo, độc lập về tài chính và tư duy. Cô ấy không yêu đương mù quáng vô lý mà sẽ đặt ra điều kiện cụ thể (ví dụ: yêu cầu chuyển nhượng 10% cổ phần dự án mới hoặc quyền phân phối độc quyền tại khu vực, ký hợp đồng thỏa thuận dịch vụ tư vấn pháp lý/đồng sáng lập với các điều khoản phân chia lợi ích sòng phẳng) trước khi hợp tác với nam chính/nữ chính.
4. KHỦNG HOẢNG 24H+: Một sự kiện dồn ép nhân vật vào chân tường kéo dài ít nhất 24 giờ liên tục, có mốc thời gian rõ ràng, đếm ngược từng tiếng (ví dụ: hạn chót trả nợ ngân hàng BIDV chi nhánh Cầu Giấy 30 tỷ trong 48 giờ nếu không bị khởi tố, hoặc 24 giờ trước khi hội đồng y tế quốc gia công bố phán quyết tước giấy phép hành nghề).
...
def main():
    print("=" * 60)
    print("🌟 REWRITE V13 & DEPLOY ENGINE (GROUP A) 🌟")
    print("=" * 60)
