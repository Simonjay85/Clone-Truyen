...
HELPER = "bulk_update_three_stories_20260522.php"

STORIES = [
    {
        "payload": ROOT / "scratch" / "duoc_v2_payload.json",
        "remote_cover": "chien-than-duoc-pham-square-1024-v1.png",
    },
    {
        "payload": ROOT / "scratch" / "vo_v2_payload.json",
        "remote_cover": "vo-than-bao-ve-square-1024-v1.png",
    },
    {
        "payload": ROOT / "scratch" / "fintech_v2_payload.json",
        "remote_cover": "thien-tai-fintech-square-1024-v1.png",
    },
]
...
foreach (($input['stories'] ?? []) as $story_data) {
    ...
    if (!empty($cover_filename)) {
        ...
        if (file_exists($local_path)) {
            $tmp = tempnam(get_temp_dir(), 'coverbulk');
