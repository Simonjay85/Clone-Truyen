...
def main():
    print("🚀 STARTING LIVE COVERS UPDATE PROCESS...")
    ...
    try:
        ...
        # Define updates
        updates = [
            {"story_id": 2573, "local_file": "scratch/de_che_gom_su_v2.png", "remote_name": "de_che_gom_su_v2.png"},
            {"story_id": 2561, "local_file": "scratch/vua_tom_hum_v2.png", "remote_name": "vua_tom_hum_v2.png"}
        ]
        ...
        ftp.quit()
        print("\n✨ Finished covers update process successfully.")
    except Exception as e:
