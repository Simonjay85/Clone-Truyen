...
<main class="max-w-7xl mx-auto px-6 py-12 flex-grow w-full min-h-screen">
...
with open("tehi-theme/page-latest.php", "w", encoding="utf-8") as f:
    f.write(php_code_latest)

print("Created page-latest.php")
