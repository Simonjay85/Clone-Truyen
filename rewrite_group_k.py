#!/usr/bin/env python3
"""
Master script: Fetch, rewrite to V13 standard, and deploy Group K stories.
Stories: 2238, 2249, 2259, 2269, 2279
...
STORY_LIST = [
    {
        "id": 2238,
        "title_hint": "Triều Đại Cà Phê Bazan Đắk Minh",
        "keywords": "triều đại cà phê bazan đắk minh, Y Dhăm Nie, Lê H'Vy, Đắk Minh, Đắk Nông, máy rang cà phê hồng ngoại, thâu tóm quỹ đầu tư, David Chen, bằng sáng chế cà phê",
        "focus_keyword": "triều đại cà phê"
    },
    {
        "id": 2249,
        "title_hint": "Nhà Thiết Kế Tàng Hình Hội Nghị Thời Trang Quốc Gia",
        "keywords": "nhà thiết kế tàng hình, hội nghị thời trang quốc gia, Hoàng Minh, Khánh An, SilkWay, Lâm Phong, thiết kế CAD, GEM Center, Hồn Lụa Việt, ăn cắp thiết kế",
        "focus_keyword": "nhà thiết kế tàng hình"
    },
    {
        "id": 2259,
        "title_hint": "Tiệm Bánh Hội Nguyên",
        "keywords": "tiệm bánh hội nguyên, Trần Gia Bảo, Minh Thư, Hội An, bánh đậu xanh, Huỳnh Tấn, SweetHome, đầu độc E.coli, an toàn thực phẩm, trung tâm Pasteur Nha Trang",
        "focus_keyword": "tiệm bánh hội nguyên"
    },
    {
        "id": 2269,
        "title_hint": "Đế Chế Dệt May Bình Thịnh",
        "keywords": "đế chế dệt may bình thịnh, dệt may Bình Thịnh, Nguyễn Bình, Phương Trinh, Nam Định, Mark Vance, TexTech, SGS Thụy Sĩ, sợi tre kháng khuẩn, lừa đảo hợp đồng",
        "focus_keyword": "đế chế dệt may"
    },
    {
        "id": 2279,
        "title_hint": "Vương Quốc Bất Động Sản Thành Tâm",
        "keywords": "vương quốc bất động sản thành tâm, Trần Thành, Ngọc Lan, MB Bank, Đà Nẵng, Trịnh Thế, Thịnh Vượng, quy hoạch giả, tranh chấp đất đai, cướp dự án",
        "focus_keyword": "vương quốc bất động sản"
    }
]
...
def main():
    print("=" * 60)
    print("🌟 MASTER REWRITE V13 & DEPLOY ENGINE (GROUP K) 🌟")
    print("=" * 60)
    ...
    print(f"GROUP_K_DONE: {deployed_ids}")
