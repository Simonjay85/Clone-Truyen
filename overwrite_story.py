...
with open("temp_regen_story.php", "w") as f:
    f.write(php_code)

try:
    ftp = ftplib.FTP("51.79.53.190")
    ftp.login("alotoinghe", "Nghia234!")
    with open("temp_regen_story.php", "rb") as f:
        ftp.storbinary("STOR temp_regen_story.php", f)
    ftp.quit()
    req = urllib.request.urlopen("https://doctieuthuyet.com/temp_regen_story.php", timeout=90)
