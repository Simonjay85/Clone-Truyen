        ...
        <div class="row text-center text-md-start align-items-center">
            <div class="col-md-6 mb-3 mb-md-0">
                <a href="<?php echo esc_url(home_url('/')); ?>" class="d-inline-flex align-items-center gap-2 text-decoration-none">
                    <img src="<?php echo get_site_url(); ?>/img_data/images/logo-truyen-moi-v1.png" alt="<?php bloginfo('name'); ?>" style="height: 40px; max-width: 100%; object-fit: contain;">
                </a>
                <p class="mt-3 text-muted" style="font-size: 0.9rem;">
                    <?php bloginfo('name'); ?> – Đọc Truyện Ngôn Tình Hay Nhất chọn lọc, nội dung cuốn hút.
                </p>
            </div>
            <div class="col-md-6 text-center text-md-end">
                <p class="mb-0 text-muted" style="font-size: 0.85rem;">
                    © 2026 <a href="<?php echo esc_url(home_url('/')); ?>" class="fw-bold text-decoration-none text-primary"><?php bloginfo('name'); ?></a>. Mọi quyền được bảo lưu.
                </p>
