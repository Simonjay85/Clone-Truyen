#!/usr/bin/env python3
"""
Master script: Fetch, rewrite to V13 standard, and deploy Group M stories.
Stories: 2482, 2489, 2497, 2508, 2517
...
STORY_LIST = [
    {
        "id": 2482,
        "title_hint": "Vương Quốc Nước Mắm Truyền Thống Phú Quốc: Chàng Rể Ẩn Thế Vực Dậy Quốc Hồn",
        "keywords": "nước mắm truyền thống phú quốc, Trịnh Gia Huy, Nguyễn Thanh Mai, Trần Thế Vinh, nhà thùng Dương Đông, resort Nam Nghi, độc quyền phân phối, Pasteur Nha Trang, kiểm nghiệm histamine, camera hồng ngoại Full HD, sao kê BIDV hối lộ",
        "focus_keyword": "nước mắm truyền thống"
    },
    {
        "id": 2489,
        "title_hint": "Người Thừa Kế Trăm Tỷ Giả Nghèo",
        "keywords": "người thừa kế trăm tỷ giả nghèo, Nguyễn Minh Triết, Lê Vy Anh, bà Mai, Thùy Chi, Tuấn Phong, Quỹ ủy thác tài sản Thịnh Phát, Landmark 81, Phú Mỹ Hưng, camera an ninh Full HD sảnh biệt thự, sao kê tài khoản Techcombank đóng dấu giáp lai đỏ",
        "focus_keyword": "người thừa kế trăm tỷ"
    },
    {
        "id": 2497,
        "title_hint": "Công Thức Thuốc Bị Cướp: Bẫy IPO Dược Phẩm Nghìn Tỷ",
        "keywords": "công thức thuốc bị cướp, Nguyễn Đức Trí, Lâm Gia Hân, Trần Đại Nghĩa, Dược phẩm Đông Á, Dược phẩm An Bình, lab chuẩn ISO 17025 Quận 9, git log hash blockchain, Viện Vệ sinh Dịch tễ Trung ương, IPO HOSE, ghi âm phòng lab Đà Lạt",
        "focus_keyword": "công thức thuốc"
    },
    {
        "id": 2508,
        "title_hint": "Bảo Vệ Quèn Là Võ Thần: Phá Bẫy Buôn Lậu 500 Tỷ Cảng Đình Vũ",
        "keywords": "bảo vệ quèn là võ thần, Hoàng Việt, Nguyễn Minh Tuyền, Trần Quốc Hùng, Sơn Tàu, cảng Đình Vũ Hải Phòng, container ngà voi 500 tỷ, an ninh Đông Hải, khôi phục camera hồng ngoại đầu ghi trung tâm, nhật ký GPS hành trình, ghi âm phổ âm học",
        "focus_keyword": "võ thần bảo vệ"
    },
    {
        "id": 2517,
        "title_hint": "Thiên Tài Fintech Bị Cướp App: Blockchain Lật Kèo Series B",
        "keywords": "thiên tài fintech bị cướp app, Phạm Tuấn Kiệt, Lê Minh An, Đỗ Thế Nam, PayViet, PayBlock, Cục Sở hữu Trí tuệ Việt Nam, mã hash SHA-256 khối Genesis, chữ ký khóa PGP Git history, Keangnam Landmark 72, sao kê Vietcombank hối lộ",
        "focus_keyword": "blockchain lật kèo"
    }
]
...
3. KHỦNG HOẢNG 24H+ & NỮ CHÍNH LÝ TÍNH: Thể hiện rõ nét các mâu thuẫn được dồn nén nghẹt thở liên tục trên 24 giờ và sự xuất sắc, lý trí đặt điều kiện thương lượng sòng phẳng của nhân vật nữ chính (chuyển nhượng tài sản đứng tên riêng, cổ phần sở hữu trí tuệ rõ ràng trước khi ra tay giúp đỡ).
  ...
  "content": "[Nội dung chương viết hoàn chỉnh bằng Tiếng Việt 100%, định dạng HTML với các thẻ <p> cho TỪNG CÂU VĂN]"
    ...
    for parse_attempt in range(3):
        try:
            ...
            if w_count < 1000:
                orig_title = chap_data.get("title", f"Chương {idx}")
...
Hãy viết lại chương này, giữ nguyên cốt truyện nhưng MỞ RỘNG cực kỳ chi tiết, thêm nhiều đoạn đối thoại đấu trí sắc bén, miêu tả vật lý chi tiết hơn nữa để đạt độ dài TRÊN 1000 từ. Vẫn tuân thủ luật HTML mỗi câu văn nằm trong 1 thẻ `<p>` riêng biệt. Trả về JSON y hệt."""
                ...
                expanded_data["content"] = clean_and_format_html(expanded_data["content"])
                if "title" not in expanded_data or not expanded_data["title"]:
                    expanded_data["title"] = orig_title
                chap_data = expanded_data
...
2. BỐI CẢNH ĐỊA DANH THẬT HOẶC BIẾN TẤU CHUẨN VIỆT NAM: Câu chuyện phải diễn ra tại các địa điểm cụ thể chuẩn Việt Nam (Quận 1, Quận 3, Cầu Giấy, Láng Hạ, Landmark 81, hồ Tây, Hải Phòng, Cảng Đình Vũ, Phú Quốc, v.v.). Các tòa nhà, văn phòng cụ thể. Tên nhân vật thuần Việt.
3. NỮ CHÍNH LÝ TÍNH ĐẶT ĐIỀU KIỆN TRƯỚC KHI HỢP TÁC: Nữ chính hoặc trợ lý đồng hành là người cực kỳ tài năng, có đầu óc sắc sảo, độc lập về tài chính và tư duy. Cô ấy không yêu đương mù quáng vô lý mà sẽ đặt ra điều kiện cụ thể (chuyển nhượng sở hữu tài sản riêng, ký hợp đồng dịch vụ tư vấn pháp lý rõ ràng, hoặc phân chia cổ phần sòng phẳng quyền sở hữu trí tuệ) trước khi hợp tác với nam chính hoặc xử lý khủng hoảng giúp người khác.
...
def main():
    print("=" * 60)
    print("🌟 MASTER REWRITE V13 & DEPLOY ENGINE (GROUP M) 🌟")
    print("=" * 60)
    
    # Read fetched metadata
    metadata_path = "/Users/aaronnguyen/TN/App/doctieuthuyet/scratch/group_m_metadata.json"
    ...
    print(f"GROUP_M_DONE: {deployed_ids}")
