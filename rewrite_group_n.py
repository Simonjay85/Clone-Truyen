#!/usr/bin/env python3
"""
Master script: Fetch, rewrite to V13 standard, and deploy Group N stories.
Stories: 2549, 2561, 2573, 2587, 2606, 2658
...
STORY_LIST = [
    {
        "id": 2549,
        "title_hint": "Bão Nổi Miền Tây: Vương Quốc Sầu Riêng Trăm Tỷ Của Chàng Rể Hào Môn",
        "keywords": "Nguyễn Tấn Đạt, Trần Mỹ Duyên, Huỳnh Hữu Lộc, sầu riêng Monthong Trần Gia, Chợ Lách Bến Tre, thâu tóm nợ xấu Vietcombank, Cảng Cát Lái, camera hồng ngoại Full HD, độc cỏ glyphosate, sao kê tài khoản ngân hàng BIDV hối lộ, chi cục bảo vệ thực vật Bến Tre",
        "focus_keyword": "vương quốc sầu riêng"
    },
    {
        "id": 2561,
        "title_hint": "Vua Tôm Hùm Phú Yên: Chàng Ngư Dân Bị Khinh Rẻ Thâu Tóm Vùng Biển Nghìn Tỷ",
        "keywords": "Trần Hải Phong, Lê Phương Linh, Hợp tác xã, vịnh Xuân Đài, Sông Cầu Phú Yên, tôm hùm giáp vàng F3, dịch bệnh sữa, thương lái ép giá, ghi âm phổ âm học kỹ thuật số, vắc-xin kháng dịch, kiểm định sinh học phân tử chuẩn ISO 17025",
        "focus_keyword": "vua tôm hùm"
    },
    {
        "id": 2573,
        "title_hint": "Đế Chế Gốm Sứ Bát Tràng: Nghệ Nhân Bị Phản Bội Thiêu Đốt Cả Làng Nghề",
        "keywords": "Nguyễn Quang Minh, Phạm Thu Hương, Trần Thế Hải, công thức men ngọc rạn ngũ đại, làng cổ Bát Tràng, men chì độc hại, bảo tàng Gốm sứ Bát Tràng, camera Full HD tráo mẫu đất sét, log băm SHA-256 men ngọc, Viện Hóa học Việt Nam chuẩn ISO",
        "focus_keyword": "gốm sứ bát tràng"
    },
    {
        "id": 2587,
        "title_hint": "Thiên Tài Cầu Đường Cao Tốc: Kỹ Sư Bị Sa Thải Xây Cầu Vượt Biển Nghìn Tỷ",
        "keywords": "Trịnh Lâm Tùng, Đỗ Phương Vy, Lê Khắc Nam, cầu vượt biển Tân Vũ Lạch Huyện, Quỹ đầu tư hạ tầng Việt Phát, dầm bê tông dự ứng lực chịu mặn, sụt lún trụ cầu T12, Finite Element Method, git log hash SHA-256 chữ ký số khóa PGP",
        "focus_keyword": "cầu vượt biển"
    },
    {
        "id": 2606,
        "title_hint": "Chàng Rể Bị Trục Xuất Khỏi Gia Tộc Trầm Hương Tìm Ra Kỳ Nam Nghìn Tỷ Vả Sập Tập Đoàn Phản Bội",
        "keywords": "Diệp Thiên Lang, Nguyễn Thanh Thư, Lâm Vĩnh Nghiệp, gốc Kỳ Nam ngàn năm cổ thụ, Tâm Khứu ngửi linh khí, trầm hương tẩm hóa chất cực độc benzyl acetate, rừng đặc dụng Hòn Bà Nha Trang, GC-MS sắc ký khí ghép khối phổ, camera Full HD xưởng hóa chất, sao kê Techcombank hối lộ",
        "focus_keyword": "kỳ nam nghìn tỷ"
    },
    {
        "id": 2658,
        "title_hint": "Chàng Rể Ngọc Linh Bị Cướp Bằng Sâm Nghìn Tỷ Lật Kèo Đông Tây Y Đưa Tập Đoàn Phản Bội Vào Tù",
        "keywords": "Trần Hoàng Vũ, Nguyễn Minh Thư, gia đình Phạm Gia, sâm Ngọc Linh sinh học, men vi khuẩn cộng sinh rễ SB-09, độc chất gây suy tim, Viện Pasteur kiểm định chuẩn ISO, ghi âm thừa nhận đánh cắp dữ liệu, metadata lịch sử tập tin gốc, Expo Dược phẩm Quốc tế",
        "focus_keyword": "sâm ngọc linh"
    }
]
...
def main():
    print("=" * 60)
    print("🌟 MASTER REWRITE V13 & DEPLOY ENGINE (GROUP N) 🌟")
    print("=" * 60)
    
    # Read fetched metadata
    metadata_path = "/Users/aaronnguyen/TN/App/doctieuthuyet/scratch/group_n_metadata.json"
    ...
    print(f"GROUP_N_DONE: {deployed_ids}")
