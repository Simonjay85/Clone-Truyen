...
function dtt_image_loading_hardening() {
    ...
    $fallback = get_template_directory_uri() . '/img_data/images/no-image-cover-v5.png?v=5';
    ?>
        ...
        function tuneDttImages() {
            ...
            images.forEach(function (img, index) {
                ...
                if (!img.dataset.dttFallbackBound) {
                        ...
                        this.dataset.                        this.dataset.             s.removeAttribute('srcset');
