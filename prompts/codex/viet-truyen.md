...
* **Mục đích**: Người dùng dán trực tiếp một Prompt duy nhất vào giao diện Chat (Claude 3.5 Opus hoặc Gemini) để nhận về một file JSON duy nhất chứa toàn bộ nội dung bộ truyện.
...
8. ĐỊNH DẠNG: Chỉ sử dụng các thẻ HTML cơ bản như <p>, <strong>, <em>. Cấm lặp lại tiêu đề chương bên trong nội dung. Không thêm bất kỳ ghi chú của tác giả hay đoạn text meta giải thích nào bên ngoài JSON.
